...
export const SPECIALS_BY_CHARACTER = {
  yellow: {
    ...
    startup: 380, // longer wind-up — telegraphs a single enormous swing, and no longer faster to throw than Barbarian's slam despite hitting harder
    active: 160,
    recovery: 420,
    damage: 32, // brought down from 40 — was the hardest-hitting special in the game, now in line with the rest
    knockback: 480,
    knockbackUp: -220,
    hitstun: 560,
    range: 130,
...
export const ULTIMATES_BY_CHARACTER = {
  yellow: {
    ...
    active: 170,
    recovery: 400,
    damage: 46, // brought down from 58 — was the hardest-hitting ultimate in the game
    knockback: 560,
    knockbackUp: -260,
    hitstun: 620,
    range: 140,
